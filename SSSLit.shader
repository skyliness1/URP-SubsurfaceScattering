...
Shader "Universal Render Pipeline/SSSLit"
{
    Properties
    {
        ...
        */
        ...
        //[Header(BackFace)]
         [HideInInspector]_BaseColor_bk("Tint", Color) = (0.55,0.55,0.55,1)
         [HideInInspector][Toggle]_DarkBackface_AlphaClip("AlphaClip for BackFace", Float) = 0.0
